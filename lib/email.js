...
const senderName = process.env.MAILERSEND_FROM_NAME || "Personal Wallet";
...
export async function sendOTPEmail(email, otp, firstName = "User") {
  try {
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject("Verify Your Email - Personal Wallet App")
      .setHtml(getOTPEmailTemplate(otp, firstName))
      .setText(
        `Your verification code is: ${otp}. This code expires in 1 minute.`
      );
        ...
        <table role="presentation" style="width: 100%; max-width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px 40px 20px; text-align: center; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); border-radius: 16px 16px 0 0;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">Personal Wallet App</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #52525b; font-size: 16px; line-height: 1.6;">
                If you didn't create an account with Personal Wallet, you can safely ignore this email.
              </p>
              
              <p style="margin: 0; color: #52525b; font-size: 16px; line-height: 1.6;">
                Best regards,<br>
                <strong>The Personal Wallet App Team</strong>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 30px 40px; background-color: #f4f4f5; border-radius: 0 0 16px 16px; text-align: center;">
              <p style="margin: 0; color: #71717a; font-size: 14px;">
                © ${new Date().getFullYear()} Personal Wallet. All rights reserved.
              </p>
